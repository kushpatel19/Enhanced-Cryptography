...
Original file is located at
    https://colab.research.google.com/drive/1FkVFv7s5UNEMuRucuihvuXofuDc4N5JN
...
def func(x, secret_key, ascii):
    return secret_key * x * x * x - 2.7 * x - ascii


def derivfunc(x):
    return 3 * secret_key * x * x - 2.7
...
file = open("/content/Group3_Text.txt", "r")
...
#  x0 = -1
#  x1 = 5
#  cipher.append(bisection(x0, x1, 0.0001,secret_key, int(i)))
...
de.pop()
for i in de:
  msg.append(chr(round(func(float(i), secret_key))))
